...
public abstract class MaskField<R extends ConnectRecord<R>> implements Transformation<R>, Versioned {
    ...
    public static final ConfigDef CONFIG_DEF = FieldSyntaxVersion.appendConfigTo(
        new ConfigDef()
            ...
            .define(
                ...
                "Custom value replacement, that will be applied to all"
    ...
    public void configure(Map<String, ?> props) {
        ...
        maskedFields = new MultiFieldPaths(config.getList(FIELDS_CONFIG), FieldSyntaxVersion.fromConfig(config));

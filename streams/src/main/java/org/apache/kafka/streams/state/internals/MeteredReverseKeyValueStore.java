 ...
 * @param <V>
 */
public class MeteredReverseKeyValueStore<K, V>
    extends WrappedStateStore<KeyValueStoreWithReverseIteration<Bytes, byte[]>, K, V>
    implements KeyValueStoreWithReverseIteration<K, V> {
    ...
    MeteredReverseKeyValueStore(final KeyValueStoreWithReverseIteration<Bytes, byte[]> inner,

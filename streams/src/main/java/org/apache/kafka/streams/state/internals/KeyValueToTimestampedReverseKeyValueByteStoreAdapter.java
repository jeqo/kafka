 ...
 */
public class KeyValueToTimestampedReverseKeyValueByteStoreAdapter implements KeyValueStoreWithReverseIteration<Bytes, byte[]> {
    final KeyValueStoreWithReverseIteration<Bytes, byte[]> store;

    KeyValueToTimestampedReverseKeyValueByteStoreAdapter(final KeyValueStoreWithReverseIteration<Bytes, byte[]> store) {
        if (!store.persistent()) {

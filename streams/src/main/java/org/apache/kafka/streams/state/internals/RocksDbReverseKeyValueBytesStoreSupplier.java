...
public class RocksDbReverseKeyValueBytesStoreSupplier implements ReverseKeyValueBytesStoreSupplier {

    private final String name;
    private final boolean returnTimestampedStore;

    public RocksDbReverseKeyValueBytesStoreSupplier(final String name,

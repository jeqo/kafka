 ...
 * @param <V>
 */
public class MeteredTimestampedReverseKeyValueStore<K, V>
    extends MeteredReverseKeyValueStore<K, ValueAndTimestamp<V>>
    implements TimestampedKeyValueStoreWithReverseIteration<K, V> {

    MeteredTimestampedReverseKeyValueStore(final KeyValueStoreWithReverseIteration<Bytes, byte[]> inner,

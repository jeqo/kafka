...
public class ChangeLoggingTimestampedReverseKeyValueBytesStore extends ChangeLoggingReverseKeyValueBytesStore {

    ChangeLoggingTimestampedReverseKeyValueBytesStore(final KeyValueStoreWithReverseIteration<Bytes, byte[]> inner) {
        super(inner);
    }

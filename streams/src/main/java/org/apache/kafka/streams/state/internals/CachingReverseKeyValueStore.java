...
public class CachingReverseKeyValueStore
    extends WrappedStateStore<KeyValueStoreWithReverseIteration<Bytes, byte[]>, byte[], byte[]>
    implements KeyValueStoreWithReverseIteration<Bytes, byte[]>, CachedStateStore<byte[], byte[]> {

    private static final Logger LOG = LoggerFactory.getLogger(CachingReverseKeyValueStore.class);
    ...
    CachingReverseKeyValueStore(final KeyValueStoreWithReverseIteration<Bytes, byte[]> underlying) {
        super(underlying);
    }

...
public class ChangeLoggingReverseKeyValueBytesStore
    extends WrappedStateStore<KeyValueStoreWithReverseIteration<Bytes, byte[]>, byte[], byte[]>
    implements KeyValueStoreWithReverseIteration<Bytes, byte[]> {

    InternalProcessorContext context;

    ChangeLoggingReverseKeyValueBytesStore(final KeyValueStoreWithReverseIteration<Bytes, byte[]> inner) {
        super(inner);
    }
